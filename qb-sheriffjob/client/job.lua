...
RegisterNetEvent('sheriff:client:EvidenceStashDrawer', function()
    ...
    CreateThread(function()
        while true do
            ...
            if inEvidence and PlayerJob.type == 'leo' then
                if PlayerJob.onduty then sleep = 5 end
                if IsControlJustReleased(0, 38) then
                    TriggerEvent('sheriff:client:EvidenceStashDrawer')
                    break
                end
            else
                break
...
if Config.UseTarget then
    CreateThread(function()
        ...
        for k, v in pairs(Config.Locations['duty']) do
            exports['qb-target']:AddCircleZone('sheriffDuty_' .. k, vector3(v.x, v.y, v.z), 0.5, {
                name = 'sheriffDuty_' .. k,
                useZ = true,
                debugPoly = false,
            }, {
        ...
        for k, v in pairs(Config.Locations['stash']) do
            exports['qb-target']:AddCircleZone('sheriffStash_' .. k, vector3(v.x, v.y, v.z), 1.0, {
        ...
        for k, v in pairs(Config.Locations['trash']) do
            exports['qb-target']:AddCircleZone('sheriffTrash_' .. k, vector3(v.x, v.y, v.z), 0.5, {
        ...
        for k, v in pairs(Config.Locations['fingerprint']) do
            exports['qb-target']:AddCircleZone('sheriffFingerprint_' .. k, vector3(v.x, v.y, v.z), 0.5, {
        ...
        for k, v in pairs(Config.Locations['armory']) do
            exports['qb-target']:AddCircleZone('sheriffArmory_' .. k, vector3(v.x, v.y, v.z), 1.0, {
        ...
        -- Evidence
        for k, v in pairs(Config.Locations['evidence']) do
            exports['qb-target']:AddCircleZone('sheriffEvidence_' .. k, vector3(v.x, v.y, v.z), 0.5, {
                name = 'sheriffEvidence_' .. k,
                useZ = true,
                debugPoly = false,
            }, {
                options = {
