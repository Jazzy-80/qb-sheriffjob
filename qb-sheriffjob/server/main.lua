...
local function UpdateBlips()
    ...
    for _, v in pairs(players) do
        if v and (v.PlayerData.job.type == 'sheriff' or v.PlayerData.job.type == 'ambulance') and v.PlayerData.job.onduty then
...
RegisterNetEvent('sheriff:server:BillPlayer', function(playerId, price)
    ...
    exports['qb-banking']:AddMoney('sheriff', price, 'Fine paid')
